...
const Footer: React.FC<Props> = () => {
  return (
    <section className="p-20 pb-10 pt-32 bg-black rounded-bl-4xl rounded-br-4xl animate-in slide-in-from-bottom">
      <div className="flex row justify-between items-center">
        <ul className="flex space-x-8 text-gray2 wow fadeIn">
          <li>
            <a href="/">About</a>
          </li>
          <li>
        ...
        <p className="text-6xl text-gray-light wow fadeIn">hello@ramos.com</p>
      </div>
      <hr className="border-gray2 h-2 mt-10 mb-10" />

      <div className="grid grid-cols-4 gap-4 wow fadeIn">
        <div className="text-gray-light">
          <p className="">Warrensville Heights</p>
          <p className="text-gray2">
            14418 Vineyard Drive, NC <br /> 44128
          </p>
        </div>
        <div className="text-gray-light wow fadeIn">
          <p className="">Saint Louis</p>
          <p className="text-gray2">
            1366 Penn
            <br /> Street
          </p>
        </div>
        <div className="col-span-2 text-right text-gray">
